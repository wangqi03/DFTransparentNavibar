#
#  Be sure to run `pod spec lint DFTransparentNavibar.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                       You set the navibar's color/backgound in a shared instance.
  ...
  s.author             = { "WANG Haojiao" => "wangqi03@outlook.com" }
  # Or just: s.author    = "WANG Haojiao"
  # s.authors            = { "WANG Haojiao" => "wangqi03@outlook.com" }
  # s.social_media_url   = "http://twitter.com/WANG Haojiao"
  ...
  s.source       = { :git => "https://github.com/wangqi03/DFTransparentNavibar.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "TransparentNavibar/DFTransparentNavibar/**/*.{h,m}"
